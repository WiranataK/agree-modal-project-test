...
export class Table_Partner extends React.Component {
  constructor(props) {
    super(props);
    this.arrPartner = [];
  }
  ...
  fillTable(){
      ...
      this.arrPartner.forEach((partner, i) => {
