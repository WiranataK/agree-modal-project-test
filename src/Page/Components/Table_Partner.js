                ...
                <tbody className="body">
                    {
                        arrPartner.map((element) => {
                            ...
                            return (
                              <tr>
                                  <th>{index}</th>
                                  <th>{element["partner_type"]}</th>
                                  <th>{element["partner_code"]}</th>
                                  <th>{element["partner_name"]}</th>
                                  <th>{element["nickname"]}</th>
                                  <th>{element["birthplace"]}</th>
                                  <th>{element["date_of_birth"]}</th>
                                  <th>{element["gender"]}</th>
                                  <th>{element["religion"]}</th>
                                  <th>{element["language"]}</th>
                                  <th>{element["nationality"]}</th>
                                  <th>
                                      <Button className="buttons1" variant="primary" value={element["partner_code"]}>
                                  ...
                                  <th>
                                      <Button className="buttons2" variant="primary" value={element["partner_code"]}>
